/*02-Crie uma função que receba 3 números como parâmetro e retorne o MENOR dentre eles.
Aluno: Davi Emanuel Baptista Furlan */

function menorNumero(n1: number, n2: number, n3: number){
    if(n1 < n2 && n1 < n3) {
        menor = n1
    } else {
        if (n2 < n3 && n3 < n2) {
...
console.log(menorNumero(n1, n2, n3))
